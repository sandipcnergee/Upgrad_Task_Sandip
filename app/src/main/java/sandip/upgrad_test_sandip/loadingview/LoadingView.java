package sandip.upgrad_test_sandip.loadingview;
...
public class LoadingView extends ViewSwitcher {
	...
	public void setLoading(boolean state) {
		if ((getCurrentView() == loadingView) != state) {
			...
			if(state){
				((ProgressWheel) findViewById(R.id.progress_wheel)).setVisibility(View.VISIBLE);
			}
			else{
				((ProgressWheel) findViewById(R.id.progress_wheel)).setVisibility(View.GONE);
			}
			showNext();
		}
	}
